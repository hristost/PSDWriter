#
#  Be sure to run `pod spec lint PSDWriter.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Ben Gotow" => "email@address.com" }
  # Or just: spec.author    = "Ben Gotow"
  # spec.authors            = { "Ben Gotow" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/Ben Gotow"
